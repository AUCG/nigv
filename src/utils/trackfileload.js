...
export default class TrackFileLoad {
    constructor() {
        var self = this;
        ...
        // drag & drop surface
        this.drag_drop_surface(this, this.$container);
        ...
        const indexExtensionToKey = _.invert(_.mapObject(this.keyToIndexExtension, function (val) { return val.extension; }));
    }

    warnWithMessage(message) {
        this.$warning.find('#warning-message').text(message);
        this.$warning.show();
    }


    isIndexFile(fileOrURL) {
        var extension;
    ...
    indexFilesMissingAssociatedDataFilesAndWarningBlurb(dataFiles, indexFiles) {
        var keysMissing,
            filenames,
            blurb;
    ...
    dataFilesMissingAssociatedIndexFilesAndWarningBlurb(dataFiles, indexFiles) {
        var keysMissing,
            filenames,
            missing,
            blurb;
    ...
    drag_drop_surface(trackFileLoader, $parent) {
        ...
        // load URL
        this.url_input_container(trackFileLoader, trackFileLoader.$drag_drop_surface);
    ...
    url_input_container(trackFileLoader, $parent) {
